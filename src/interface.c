...
create_window_hand (void)
{
  ...
  GtkWidget *rewind_play1;
  GtkWidget *image997;
  GtkWidget *complete_play1;
  GtkWidget *image998;
  GtkWidget *play1;
  GtkWidget *contract1;
  ...
  jump_to1 = gtk_image_menu_item_new_from_stock ("gtk-jump-to", accel_group);
  gtk_widget_show (jump_to1);
  gtk_container_add (GTK_CONTAINER (menuitem1_menu), jump_to1);
  ...
  image987 = gtk_image_new_from_stock ("gtk-paste", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image987);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (append1), image987);
  ...
  export_as_pdf1 = gtk_menu_item_new_with_mnemonic (_("Export as PDF"));
  gtk_widget_show (export_as_pdf1);
  gtk_container_add (GTK_CONTAINER (menuitem1_menu), export_as_pdf1);
  ...
  deal_new = gtk_image_menu_item_new_with_mnemonic (_("_New board"));
  gtk_widget_show (deal_new);
  gtk_container_add (GTK_CONTAINER (menuitem1_menu), deal_new);

  image988 = gtk_image_new_from_stock ("gtk-new", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image988);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (deal_new), image988);

  deal_cut = gtk_image_menu_item_new_from_stock ("gtk-cut", accel_group);
  gtk_widget_show (deal_cut);
  gtk_container_add (GTK_CONTAINER (menuitem1_menu), deal_cut);

  deal_copy = gtk_image_menu_item_new_from_stock ("gtk-copy", accel_group);
  gtk_widget_show (deal_copy);
  gtk_container_add (GTK_CONTAINER (menuitem1_menu), deal_copy);

  deal_paste = gtk_image_menu_item_new_from_stock ("gtk-paste", accel_group);
  gtk_widget_show (deal_paste);
  gtk_container_add (GTK_CONTAINER (menuitem1_menu), deal_paste);

  deal_separator = gtk_separator_menu_item_new ();
  gtk_widget_show (deal_separator);
  gtk_container_add (GTK_CONTAINER (menuitem1_menu), deal_separator);
  gtk_widget_set_sensitive (deal_separator, FALSE);

  imp_table1 = gtk_image_menu_item_new_with_mnemonic (_("IMP _table..."));
  gtk_widget_show (imp_table1);
  gtk_container_add (GTK_CONTAINER (menuitem1_menu), imp_table1);

  image989 = gtk_image_new_from_stock ("gtk-justify-fill", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image989);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (imp_table1), image989);

  options1 = gtk_image_menu_item_new_with_mnemonic (_("O_ptions..."));
  gtk_widget_show (options1);
  gtk_container_add (GTK_CONTAINER (menuitem1_menu), options1);

  image990 = gtk_image_new_from_stock ("gtk-properties", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image990);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (options1), image990);

  info1 = gtk_image_menu_item_new_with_mnemonic (_("_Info..."));
  gtk_widget_show (info1);
  gtk_container_add (GTK_CONTAINER (menuitem1_menu), info1);

  image991 = gtk_image_new_from_stock ("gtk-info", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image991);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (info1), image991);
  ...
  image992 = gtk_image_new_from_stock ("gtk-home", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image992);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (dealer1), image992);
  ...
  image993 = gtk_image_new_from_stock ("gtk-help", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image993);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (vulnerable1), image993);
  ...
  image994 = gtk_image_new_from_stock ("gtk-delete", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image994);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (deal_clear), image994);
  ...
  image995 = gtk_image_new_from_stock ("gtk-select-color", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image995);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (deal_random), image995);

  flip1 = gtk_image_menu_item_new_with_mnemonic (_("_Flip hands"));
  gtk_widget_show (flip1);
  gtk_container_add (GTK_CONTAINER (deal1_menu), flip1);

  image996 = gtk_image_new_from_stock ("gtk-refresh", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image996);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (flip1), image996);
  ...
  gtk_container_add (GTK_CONTAINER (deal1_menu), separator10);
  gtk_widget_set_sensitive (separator10, FALSE);

  rewind_play1 = gtk_image_menu_item_new_with_mnemonic (_("Rewind play"));
  gtk_widget_show (rewind_play1);
  gtk_container_add (GTK_CONTAINER (deal1_menu), rewind_play1);
  gtk_tooltips_set_tip (tooltips, rewind_play1, _("Undo all cards"), NULL);

  image997 = gtk_image_new_from_stock ("gtk-goto-first", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image997);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (rewind_play1), image997);

  complete_play1 = gtk_image_menu_item_new_with_mnemonic (_("Complete play"));
  gtk_widget_show (complete_play1);
  gtk_container_add (GTK_CONTAINER (deal1_menu), complete_play1);
  gtk_tooltips_set_tip (tooltips, complete_play1, _("Play all cards"), NULL);

  image998 = gtk_image_new_from_stock ("gtk-goto-last", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image998);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (complete_play1), image998);

  play1 = gtk_check_menu_item_new_with_mnemonic (_("Show pla_y..."));
  gtk_widget_show (play1);
  gtk_container_add (GTK_CONTAINER (deal1_menu), play1);
  ...
  image999 = gtk_image_new_from_stock ("gtk-index", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image999);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (level_menu1), image999);
  ...
  gtk_container_add (GTK_CONTAINER (contract1_menu), separator6);
  ...
  gtk_container_add (GTK_CONTAINER (contract1_menu), separator7);
  ...
  image1000 = gtk_image_new_from_stock ("gtk-stop", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image1000);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (double1), image1000);
  ...
  score1 = gtk_menu_item_new_with_mnemonic (_("_Analysis"));
  ...
  image1001 = gtk_image_new_from_stock ("gtk-convert", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image1001);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (double_dummy1), image1001);

  dd_always1 = gtk_check_menu_item_new_with_mnemonic (_("Always run DD"));
  gtk_widget_show (dd_always1);
  gtk_container_add (GTK_CONTAINER (score1_menu), dd_always1);
  gtk_tooltips_set_tip (tooltips, dd_always1, _("Automatically run DD analysis"), NULL);

  separator4 = gtk_separator_menu_item_new ();
  gtk_widget_show (separator4);
  gtk_container_add (GTK_CONTAINER (score1_menu), separator4);
  ...
  image1002 = gtk_image_new_from_stock ("gtk-find", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image1002);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (parscore1), image1002);

  set_par1 = gtk_image_menu_item_new_with_mnemonic (_("Play par contract"));
  ...
  image1003 = gtk_image_new_from_stock ("gtk-find-and-replace", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image1003);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (set_par1), image1003);
  ...
  gtk_tool_item_set_tooltip (GTK_TOOL_ITEM (rewind_button), tooltips, _("Rewind trick"), NULL);
  ...
  gtk_tool_item_set_tooltip (GTK_TOOL_ITEM (button_back), tooltips, _("Rewind card"), NULL);
  ...
  gtk_tool_item_set_tooltip (GTK_TOOL_ITEM (button_fast_forward), tooltips, _("Play next trick"), NULL);
  ...
  button_dd = (GtkWidget*) gtk_tool_button_new_from_stock ("gtk-convert");
  ...
  label_board = gtk_label_new ("Open 1\n4\342\231\245 N");
  ...
  g_signal_connect ((gpointer) speichern_unter1, "activate",
                    ...
                    NULL);
  g_signal_connect ((gpointer) export_as_pdf1, "activate",
                    G_CALLBACK (on_export_as_pdf1_activate),
                    NULL);
  ...
  g_signal_connect ((gpointer) deal_line, "activate",
                    ...
                    NULL);
  g_signal_connect ((gpointer) rewind_play1, "activate",
                    G_CALLBACK (on_rewind_play1_activate),
                    NULL);
  g_signal_connect ((gpointer) complete_play1, "activate",
                    G_CALLBACK (on_complete_play1_activate),
                    NULL);
  ...
  g_signal_connect ((gpointer) double_dummy1, "activate",
                    ...
                    NULL);
  g_signal_connect ((gpointer) dd_always1, "activate",
                    G_CALLBACK (on_dd_always1_activate),
                    NULL);
  ...
  g_signal_connect ((gpointer) button_fast_forward, "clicked",
                    ...
                    NULL);
  g_signal_connect ((gpointer) button_dd, "clicked",
                    G_CALLBACK (on_button_dd_clicked),
                    NULL);
  ...
  GLADE_HOOKUP_OBJECT (window_hand, deal_separator, "deal_separator");
  GLADE_HOOKUP_OBJECT (window_hand, imp_table1, "imp_table1");
  GLADE_HOOKUP_OBJECT (window_hand, image989, "image989");
  GLADE_HOOKUP_OBJECT (window_hand, options1, "options1");
  GLADE_HOOKUP_OBJECT (window_hand, image990, "image990");
  GLADE_HOOKUP_OBJECT (window_hand, info1, "info1");
  GLADE_HOOKUP_OBJECT (window_hand, image991, "image991");
  ...
  GLADE_HOOKUP_OBJECT (window_hand, image992, "image992");
  ...
  GLADE_HOOKUP_OBJECT (window_hand, image993, "image993");
  ...
  GLADE_HOOKUP_OBJECT (window_hand, image994, "image994");
  GLADE_HOOKUP_OBJECT (window_hand, deal_random, "deal_random");
  GLADE_HOOKUP_OBJECT (window_hand, image995, "image995");
  GLADE_HOOKUP_OBJECT (window_hand, flip1, "flip1");
  GLADE_HOOKUP_OBJECT (window_hand, image996, "image996");
  ...
  GLADE_HOOKUP_OBJECT (window_hand, separator10, "separator10");
  GLADE_HOOKUP_OBJECT (window_hand, rewind_play1, "rewind_play1");
  GLADE_HOOKUP_OBJECT (window_hand, image997, "image997");
  GLADE_HOOKUP_OBJECT (window_hand, complete_play1, "complete_play1");
  GLADE_HOOKUP_OBJECT (window_hand, image998, "image998");
  ...
  GLADE_HOOKUP_OBJECT (window_hand, image999, "image999");
  ...
  GLADE_HOOKUP_OBJECT (window_hand, separator6, "separator6");
  ...
  GLADE_HOOKUP_OBJECT (window_hand, separator7, "separator7");
  GLADE_HOOKUP_OBJECT (window_hand, double1, "double1");
  GLADE_HOOKUP_OBJECT (window_hand, image1000, "image1000");
  ...
  GLADE_HOOKUP_OBJECT (window_hand, image1001, "image1001");
  GLADE_HOOKUP_OBJECT (window_hand, dd_always1, "dd_always1");
  GLADE_HOOKUP_OBJECT (window_hand, separator4, "separator4");
  GLADE_HOOKUP_OBJECT (window_hand, parscore1, "parscore1");
  GLADE_HOOKUP_OBJECT (window_hand, image1002, "image1002");
  GLADE_HOOKUP_OBJECT (window_hand, set_par1, "set_par1");
  GLADE_HOOKUP_OBJECT (window_hand, image1003, "image1003");
...
create_window_options (void)
{
  ...
  GtkWidget *label99;
  GtkWidget *hbox5;
  GtkWidget *show_as_text;
  GSList *show_as_text_group = NULL;
  GtkWidget *show_as_cards;
  GtkWidget *show_played_cards;
  GtkWidget *svg_file;
  ...
  GtkWidget *label102;
  GtkWidget *hbox6;
  GtkWidget *show_hand_all;
  GSList *show_hand_all_group = NULL;
  GtkWidget *show_hand_ns;
  GtkWidget *show_hand_ew;
  GtkWidget *label103;
  GtkWidget *hbox7;
  GtkWidget *show_dd_all;
  GSList *show_dd_all_group = NULL;
  GtkWidget *show_dd_ns;
  ...
  gtk_table_attach (GTK_TABLE (table9), label97, 0, 1, 3, 4,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label97), 0, 0.5);
  gtk_misc_set_padding (GTK_MISC (label97), 0, 5);

  label98 = gtk_label_new (_("Filename"));
  gtk_widget_show (label98);
  gtk_table_attach (GTK_TABLE (table9), label98, 0, 1, 2, 3,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label98), 0, 0.5);
  gtk_misc_set_padding (GTK_MISC (label98), 0, 5);

  label99 = gtk_label_new (_("Show as "));
  gtk_widget_show (label99);
  gtk_table_attach (GTK_TABLE (table9), label99, 0, 1, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label99), 0, 0.5);
  gtk_misc_set_padding (GTK_MISC (label99), 0, 5);

  hbox5 = gtk_hbox_new (FALSE, 0);
  gtk_widget_show (hbox5);
  gtk_table_attach (GTK_TABLE (table9), hbox5, 1, 2, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0, 0);

  show_as_text = gtk_radio_button_new_with_mnemonic (NULL, _("Text"));
  gtk_widget_show (show_as_text);
  gtk_box_pack_start (GTK_BOX (hbox5), show_as_text, FALSE, FALSE, 0);
  gtk_radio_button_set_group (GTK_RADIO_BUTTON (show_as_text), show_as_text_group);
  show_as_text_group = gtk_radio_button_get_group (GTK_RADIO_BUTTON (show_as_text));
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (show_as_text), TRUE);

  show_as_cards = gtk_radio_button_new_with_mnemonic (NULL, _("Cards"));
  gtk_widget_show (show_as_cards);
  gtk_box_pack_start (GTK_BOX (hbox5), show_as_cards, FALSE, FALSE, 5);
  gtk_radio_button_set_group (GTK_RADIO_BUTTON (show_as_cards), show_as_text_group);
  show_as_text_group = gtk_radio_button_get_group (GTK_RADIO_BUTTON (show_as_cards));

  show_played_cards = gtk_check_button_new_with_mnemonic (_("Show"));
  gtk_widget_show (show_played_cards);
  gtk_table_attach (GTK_TABLE (table9), show_played_cards, 1, 2, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);

  svg_file = gtk_file_chooser_button_new (_("Select File"), GTK_FILE_CHOOSER_ACTION_OPEN);
  gtk_widget_show (svg_file);
  gtk_table_attach (GTK_TABLE (table9), svg_file, 1, 2, 2, 3,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table9), spinbutton_card_width, 1, 2, 3, 4,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_spin_button_set_numeric (GTK_SPIN_BUTTON (spinbutton_card_width), TRUE);

  label100 = gtk_label_new (_("Played cards  "));
  gtk_widget_show (label100);
  gtk_table_attach (GTK_TABLE (table9), label100, 0, 1, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label100), 0, 0.5);
  gtk_misc_set_padding (GTK_MISC (label100), 0, 5);

  label94 = gtk_label_new (_("Card display"));
  ...
  label102 = gtk_label_new (_("Show hands  "));
  gtk_widget_show (label102);
  gtk_table_attach (GTK_TABLE (table10), label102, 0, 1, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label102), 0, 0.5);
  gtk_misc_set_padding (GTK_MISC (label102), 0, 5);

  hbox6 = gtk_hbox_new (FALSE, 0);
  gtk_widget_show (hbox6);
  gtk_table_attach (GTK_TABLE (table10), hbox6, 1, 2, 0, 1,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0, 0);

  show_hand_all = gtk_radio_button_new_with_mnemonic (NULL, _("All"));
  gtk_widget_show (show_hand_all);
  gtk_box_pack_start (GTK_BOX (hbox6), show_hand_all, FALSE, FALSE, 0);
  ...
  show_hand_all_group = gtk_radio_button_get_group (GTK_RADIO_BUTTON (show_hand_ew));

  label103 = gtk_label_new (_("Show DD scores  "));
  gtk_widget_show (label103);
  gtk_table_attach (GTK_TABLE (table10), label103, 0, 1, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label103), 0, 0.5);
  gtk_misc_set_padding (GTK_MISC (label103), 0, 5);

  hbox7 = gtk_hbox_new (FALSE, 0);
  gtk_widget_show (hbox7);
  gtk_table_attach (GTK_TABLE (table10), hbox7, 1, 2, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0, 0);

  show_dd_all = gtk_radio_button_new_with_mnemonic (NULL, _("All"));
  gtk_widget_show (show_dd_all);
  gtk_box_pack_start (GTK_BOX (hbox7), show_dd_all, FALSE, FALSE, 0);
  ...
  show_dd_all_group = gtk_radio_button_get_group (GTK_RADIO_BUTTON (show_dd_ew));

  show_dd_none = gtk_radio_button_new_with_mnemonic (NULL, _("None"));
  gtk_widget_show (show_dd_none);
  gtk_box_pack_start (GTK_BOX (hbox7), show_dd_none, FALSE, FALSE, 5);
  gtk_radio_button_set_group (GTK_RADIO_BUTTON (show_dd_none), show_dd_all_group);
  show_dd_all_group = gtk_radio_button_get_group (GTK_RADIO_BUTTON (show_dd_none));

  label101 = gtk_label_new (_("Hands"));
  ...
  g_signal_connect ((gpointer) window_options, "delete_event",
                    ...
                    NULL);
  g_signal_connect ((gpointer) options_cancel, "clicked",
                    G_CALLBACK (on_options_cancel_clicked),
                    NULL);
  g_signal_connect ((gpointer) options_apply, "clicked",
                    G_CALLBACK (on_options_apply_clicked),
                    NULL);
  g_signal_connect ((gpointer) options_ok, "clicked",
                    G_CALLBACK (on_options_ok_clicked),
                    NULL);
  ...
  GLADE_HOOKUP_OBJECT (window_options, label98, "label98");
  GLADE_HOOKUP_OBJECT (window_options, label99, "label99");
  GLADE_HOOKUP_OBJECT (window_options, hbox5, "hbox5");
  GLADE_HOOKUP_OBJECT (window_options, show_as_text, "show_as_text");
  GLADE_HOOKUP_OBJECT (window_options, show_as_cards, "show_as_cards");
  GLADE_HOOKUP_OBJECT (window_options, show_played_cards, "show_played_cards");
  GLADE_HOOKUP_OBJECT (window_options, svg_file, "svg_file");
  GLADE_HOOKUP_OBJECT (window_options, spinbutton_card_width, "spinbutton_card_width");
  GLADE_HOOKUP_OBJECT (window_options, label100, "label100");
  GLADE_HOOKUP_OBJECT (window_options, label94, "label94");
  GLADE_HOOKUP_OBJECT (window_options, table10, "table10");
  GLADE_HOOKUP_OBJECT (window_options, label102, "label102");
  GLADE_HOOKUP_OBJECT (window_options, hbox6, "hbox6");
  GLADE_HOOKUP_OBJECT (window_options, show_hand_all, "show_hand_all");
  GLADE_HOOKUP_OBJECT (window_options, show_hand_ns, "show_hand_ns");
  GLADE_HOOKUP_OBJECT (window_options, show_hand_ew, "show_hand_ew");
  GLADE_HOOKUP_OBJECT (window_options, label103, "label103");
  GLADE_HOOKUP_OBJECT (window_options, hbox7, "hbox7");
  GLADE_HOOKUP_OBJECT (window_options, show_dd_all, "show_dd_all");
  GLADE_HOOKUP_OBJECT (window_options, show_dd_ns, "show_dd_ns");
