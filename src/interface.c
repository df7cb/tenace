...
create_window_hand (void)
{
  ...
  image294 = gtk_image_new_from_stock ("gtk-paste", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image294);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (append1), image294);
  ...
  image295 = gtk_image_new_from_stock ("gtk-home", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image295);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (dealer1), image295);
  ...
  image296 = gtk_image_new_from_stock ("gtk-help", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image296);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (vulnerable1), image296);
  ...
  image298 = gtk_image_new_from_stock ("gtk-delete", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image298);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (deal_clear), image298);
  ...
  image299 = gtk_image_new_from_stock ("gtk-select-color", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image299);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (deal_random), image299);

  flip1 = gtk_image_menu_item_new_with_mnemonic (_("_Flip"));
  gtk_widget_show (flip1);
  gtk_container_add (GTK_CONTAINER (deal1_menu), flip1);

  image300 = gtk_image_new_from_stock ("gtk-refresh", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image300);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (flip1), image300);
  ...
  image301 = gtk_image_new_from_stock ("gtk-index", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image301);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (level_menu1), image301);
  ...
  image302 = gtk_image_new_from_stock ("gtk-stop", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image302);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (double1), image302);
  ...
  image303 = gtk_image_new_from_stock ("gtk-convert", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image303);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (double_dummy1), image303);
  ...
  image304 = gtk_image_new_from_stock ("gtk-find", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image304);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (parscore1), image304);
  ...
  image305 = gtk_image_new_from_stock ("gtk-find-and-replace", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image305);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (set_par1), image305);
  ...
  image306 = gtk_image_new_from_stock ("gtk-justify-fill", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image306);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (imp_table1), image306);
  ...
  image307 = gtk_image_new_from_stock ("gtk-info", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image307);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (info1), image307);
  ...
  GLADE_HOOKUP_OBJECT (window_hand, image294, "image294");
  ...
  GLADE_HOOKUP_OBJECT (window_hand, image295, "image295");
  ...
  GLADE_HOOKUP_OBJECT (window_hand, image296, "image296");
  ...
  GLADE_HOOKUP_OBJECT (window_hand, image297, "image297");
  ...
  GLADE_HOOKUP_OBJECT (window_hand, image298, "image298");
  GLADE_HOOKUP_OBJECT (window_hand, deal_random, "deal_random");
  GLADE_HOOKUP_OBJECT (window_hand, image299, "image299");
  GLADE_HOOKUP_OBJECT (window_hand, flip1, "flip1");
  GLADE_HOOKUP_OBJECT (window_hand, image300, "image300");
  ...
  GLADE_HOOKUP_OBJECT (window_hand, image301, "image301");
  ...
  GLADE_HOOKUP_OBJECT (window_hand, image302, "image302");
  ...
  GLADE_HOOKUP_OBJECT (window_hand, image303, "image303");
  GLADE_HOOKUP_OBJECT (window_hand, parscore1, "parscore1");
  GLADE_HOOKUP_OBJECT (window_hand, image304, "image304");
  GLADE_HOOKUP_OBJECT (window_hand, set_par1, "set_par1");
  GLADE_HOOKUP_OBJECT (window_hand, image305, "image305");
  ...
  GLADE_HOOKUP_OBJECT (window_hand, image306, "image306");
